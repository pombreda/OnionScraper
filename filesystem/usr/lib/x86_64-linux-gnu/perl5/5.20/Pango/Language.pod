...
=item * 'batak' / 'PANGO_SCRIPT_BATAK'

=item * 'brahmi' / 'PANGO_SCRIPT_BRAHMI'

=item * 'mandaic' / 'PANGO_SCRIPT_MANDAIC'

=item * 'chakma' / 'PANGO_SCRIPT_CHAKMA'

=item * 'meroitic-cursive' / 'PANGO_SCRIPT_MEROITIC_CURSIVE'

=item * 'meroitic-hieroglyphs' / 'PANGO_SCRIPT_MEROITIC_HIEROGLYPHS'

=item * 'miao' / 'PANGO_SCRIPT_MIAO'

=item * 'sharada' / 'PANGO_SCRIPT_SHARADA'

=item * 'sora-sompeng' / 'PANGO_SCRIPT_SORA_SOMPENG'

=item * 'takri' / 'PANGO_SCRIPT_TAKRI'
