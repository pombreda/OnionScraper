...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Fri Oct 10 14:16:26 UTC 2014
 * Configured by     : Debian Project
 * Target system     : linux batsu 3.2.0-37-generic #58-ubuntu smp thu jan 24 15:28:10 utc 2013 x86_64 x86_64 x86_64 gnulinux 
 */
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/x86_64-linux-gnu/perl/5.20.1"		/**/
#define SITEARCH_EXP "/usr/local/lib/x86_64-linux-gnu/perl/5.20.1"		/**/
