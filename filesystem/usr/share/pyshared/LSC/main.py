...
gettext.install("lubuntu-software-center", "/usr/share/locale", unicode=1)
gettext.bindtextdomain("lubuntu-software-center", "/usr/share/locale")
gettext.textdomain("lubuntu-software-center")
...
class LscControl:
    ...
    def update_cache(self, widget):
        ...
        if os.path.isfile(os.path.join(
                "/usr/lib/lubuntu-software-center/apc.py")):
